...
async function captureOnboarding() {
  ...
  await page.waitForSelector('.preferred-wallets')
...
async function captureDesktop() {
  ...
  await page.getByRole('button', { name: /Enter Founder Cup|Start local practice/i }).click()
  ...
  await page.locator('.environment-nav button').filter({ hasText: 'Research' }).click()
  ...
  await page.locator('.environment-nav button').filter({ hasText: 'Ledger' }).click()
